...
if(isset($_POST['enviar'])){
    ...
    if(strlen($nombre) < 3){
        $errores[] = "Ingrese un nombre válido de al menos caracteres).";
    }
    ...
    if(strlen($asunto) < 5){
        $errores[] = "Ingrese un asunto válido de al menos 5 caracteres).";
    }

    if(strlen($comentario) < 10){
        $errores[] = "Ingrese un comentario válido de al menos 10 caracteres).";
    }
